...
- (BOOL)yk_imageHasAlpha:(UIImage *)image
{
...
- (UIImage *)yk_compress
{
    return [self yk_compressWithWidth:(CGFloat)[UIScreen mainScreen].bounds.size.width];
}

- (UIImage *)yk_compressWithWidth:(CGFloat)width
{
    return [self yk_compressWithWidth:width coefficient:0.8];
}

- (UIImage *)yk_compressWithCoefficient:(CGFloat)coefficient
{
    return [self yk_compressWithWidth:[UIScreen mainScreen].bounds.size.width coefficient:coefficient];
}

- (UIImage *)yk_compressWithWidth:(CGFloat)width coefficient:(CGFloat)coefficient
{
    NSData *data = UIImageJPEGRepresentation([UIImage yk_compressImage:self toTargetWidth:width], coefficient);
...
+ (UIImage *)yk_verticalImageFromArray:(NSArray *)imagesArray
{
    ...
    CGSize totalImageSize = [self yk_verticalAppendedTotalImageSizeFromImagesArray:imagesArray];
...
+ (CGSize)yk_verticalAppendedTotalImageSizeFromImagesArray:(NSArray *)imagesArray
{
