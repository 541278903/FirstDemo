//
//  NSObject+ykExtension.m
//
//


#import "NSObject+YYK.h"
#import <objc/runtime.h>
#import <UIKit/UIKit.h>

@implementation NSObject (YYK)
...
- (void)yk_swizzleMethod:(SEL)origSelector withMethod:(SEL)newSelector
{
    ...
    Method originaykethod = class_getInstanceMethod(class, origSelector);
    ...
    if (didAddMethod) {
        class_replaceMethod(class,
                            newSelector,
                            method_getImplementation(originaykethod),
                            method_getTypeEncoding(originaykethod));
    } else {
        method_exchangeImplementations(originaykethod, swizzledMethod);
    }
}
